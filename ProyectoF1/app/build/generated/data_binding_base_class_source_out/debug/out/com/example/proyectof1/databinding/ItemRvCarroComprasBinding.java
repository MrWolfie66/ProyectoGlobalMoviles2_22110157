...
public final class ItemRvCarroComprasBinding implements ViewBinding {
  @NonNull
  ...
  private ItemRvCarroComprasBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemRvCarroComprasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRvCarroComprasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_rv_carro_compras, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRvCarroComprasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRvCarroComprasBinding((ConstraintLayout) rootView, tvDescripcion,
